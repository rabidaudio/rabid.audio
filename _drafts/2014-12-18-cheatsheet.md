...
{% i http://upload.wikimedia.org/wikipedia/commons/d/d1/Triac.svg large %}
...
{% i cat.jpg fright medium caption=adorbs %}
...
{% i http://upload.wikimedia.org/wikipedia/commons/d/d1/Triac.svg source="Wikimedia http://commons.wikimedia.org/wiki/File:Triac.svg CC-BY-SA-30" something=else center small %}
