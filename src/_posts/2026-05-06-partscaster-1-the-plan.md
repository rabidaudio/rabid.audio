...
In April I started getting the guitar bug again. I thought about the [P-Rails](https://www.seymourduncan.com/single-product/p-rails) that were just sitting in a box. I thought about how the laser cutter allows me to make custom pickguards. And I thought about my old Strat.
...
I used Inkscape to plan out a pickguard design, using some [Jaguar/Jazzmaster dimensions I found online](https://www.electricherald.com/fender-jazzmaster-guitar-templates/). Obviously this is incomplete but you can see the vision I think.


### The plan

- Restore the Starcaster headstock, preserving the decal if possible
- Replace the tuners with Fender brand ones (leftover from when I upgraded the Tele to locking tuners)
- Attach the neck to the Squier body
- Replace the stock humbuckers with P-Rails
- Add 3x 3-way slide switches in place of the toggle switch, allowing all pickup combinations
- Move, adjust, or make a new bridge to compensate for the scale length
- cut a new pickguard with a custom decal
- Upgrade any assorted hardware I have left over (strap locks, etc)
